...
pygame.display.set_caption("吃蘋果遊戲")
...
#初始化玩家精靈組
player = MySprite()
player.load("images/farmer_walk.png", 96, 96, 8)
...
while True:
    ...
    if not game_over:
        ...
        if player_moving:
            ...
            elif player.X > 800: player.X = 800
    ...
    if game_over:
        import tkinterSqlite
        time = time / 30
        tkinterSqlite.timeCount = time
        tkinterSqlite.mainloop()
